"""
Django settings for AppWebDainattor project.
...
SECRET_KEY = 'p@#^$0s3s#0c^ks(^l4zm*5vfndg8k(u64(=lj-g70)+h1gxl1'
...
ROOT_URLCONF = 'AppWebDainattor.urls'
...
WSGI_APPLICATION = 'AppWebDainattor.wsgi.application'
